...
if (isset($_POST['add_product'])) {
   ...
   $image_folder_07 = '../uploaded_img/'.$image_07;
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, image_01, image_02, image_03, image_04, image_05, image_06, image_07) VALUES(?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $price, $image_01, $image_02, $image_03, $image_04, $image_05, $image_06, $image_07]);

      if ($insert_products) {
         if ($image_size_01 > 2000000 || $image_size_02 > 2000000 || $image_size_03 > 2000000 || $image_size_04 > 2000000 || $image_size_05 > 2000000 || $image_size_06 > 2000000 || $image_size_07 > 2000000) {
...
if (isset($_GET['delete'])) {
   ...
   unlink('../uploaded_img/'.$fetch_delete_image['image_07']);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" class="box" required placeholder="enter product price" onkeypress="if(this.value.length == 12) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="enter product details" class="box" required cols="30" rows="10"></textarea>
         </div>
      </div>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <pre><div class="details"><span><?= $fetch_products['details']; ?></span></div></pre>
      <div class="flex-btn">
         <a href="update_product?update=<?= $fetch_products['id']; ?>" class="option-btn">update</a>
         <a href="products?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
   </div>
   <?php
         }
