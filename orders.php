...
<section class="orders">
   ...
   <div class="box">
      ...
      <p>البريد الإلكتروني : <span><?= $fetch_orders['email']; ?></span></p>
      ...
      <p>المنتج المطلوب : <span><?= $fetch_orders['total_products']; ?></span></p>
      <p>السعر الإجمالي : <span>Price :- <?= $fetch_orders['total_price']; ?></span></p>
      <p> حالة الاتصال  : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
